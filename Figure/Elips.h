...
public:
    ...
    template <class class_value, class class_value1> Elips(class_value1 p, class_value r1, class_value r2);
...
Elips::Elips(class_value1 p,class_value r1, class_value r2)
{
    Center = p;
    R1 = (double)(r1);
    R2 = (double)(r2);
